...
ArchivoEmisor = pd.read_csv('Emisor-AESyECC.csv')  # Ruta del archivo CSV del emisor sin cifrado
ArchivoReceptor = pd.read_csv('Receptor-AESyECC.csv')  # Ruta del archivo CSV del receptor sin cifrado
...
ResultadodeLatencia.to_csv('Latencia-AESyECC.csv', index=False)
