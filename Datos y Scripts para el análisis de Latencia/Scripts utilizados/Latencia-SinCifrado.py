...
ArchivoEmisor = pd.read_csv('Emisor-SinCifrado.csv')  # Ruta del archivo CSV del emisor sin cifrado
ArchivoReceptor = pd.read_csv('Receptor-SinCifrado.csv')  # Ruta del archivo CSV del receptor sin cifrado
...
ResultadodeLatencia.to_csv('Latencia-SinCifrado.csv', index=False)
